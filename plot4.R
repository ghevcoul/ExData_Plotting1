...
#topright
plot(energy.sub$DateTime, energy.sub$Voltage, type="l", xlab="datetime", ylab="Voltage")
#bottomleft
...
#bottomright
plot(energy.sub$DateTime, energy.sub$Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power")
dev.off()
